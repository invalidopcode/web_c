...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'test_element.wast';
  var wasmBinaryFile = 'test_element.wasm';
  var asmjsCodeFile = 'test_element.temp.asm.js';
...
var ASM_CONSTS = [function($0, $1) { var i; var elements = document.getElementsByClassName(UTF8ToString($0)); for(i=0; i<elements.length; i++){elements[i].insertAdjacentHTML('beforeend', UTF8ToString($1));} }];
